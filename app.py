...
app.config['MONGO_URI'] = 'mongodb+srv://doadmin:A4K7IRhr061H259w@db-mongodb-sgp1-26257-c6707da3.mongo.ondigitalocean.com/admin?authSource=admin&replicaSet=db-mongodb-sgp1-26257'
mongo = PyMongo(app)
